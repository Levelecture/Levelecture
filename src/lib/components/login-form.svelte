<script lang="ts">
	...
	function handleGoogleSignIn() {
		authClient.signIn.social({ provider: 'google', callbackURL: PUBLIC_SITE_URL + '/' });
	}
</script>
...
<form class={cn('flex flex-col gap-6', className)} bind:this={ref} {...restProps}>
	<FieldGroup>
		<div class="flex flex-col items-center gap-1 text-center">
			<h1 class="text-2xl font-bold">Huft, assignments again?</h1>
			<p class="text-sm text-balance text-muted-foreground">Happy tracking, hope your grade is 67</p>
		</div>
		<!-- <Field>
